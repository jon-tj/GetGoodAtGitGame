...
const levels = [
    {
        ...
        files: [
            ...
            { name: "node_modules", icon: "📁", shouldIgnore: true, content: '[Directory containing 1,247 packages]\n\nThis folder is auto-generated by npm install.\nNever commit this to version control!' },
    ...
    },
    {
        ...
        files: [
            ...
            { name: "node_modules", icon: "📁", shouldIgnore: true, content: '[Directory: 2,341 packages, 189MB]\n\nRun npm install to regenerate.' },
            { name: ".env.local", icon: "⚙️", shouldIgnore: true, content: 'NEXT_PUBLIC_API_URL=http://localhost:3000\nSTRIPE_SECRET_KEY=sk_test_51ABC123\nJWT_SECRET=my-super-secret-jwt-key' },
            { name: "dist", icon: "📁", shouldIgnore: true, content: '[Build output directory]\n\nGenerated by npm run build.\nShould be gitignored.' },
            { name: ".next", icon: "📁", shouldIgnore: true, content: '[Next.js build cache]\n\nAuto-generated, always ignore.' },
